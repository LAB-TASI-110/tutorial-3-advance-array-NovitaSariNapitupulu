// Delimiter: Start of Code (nilai_02.c)
...
/**
 * @brief Fungsi utama program. Membaca input, menghitung total, rata-rata, dan jumlah nilai
 *        di atas atau sama dengan rata-rata, lalu mencetak hasilnya.
...
int main(void) {
    ...
    // Mencetak total, rata-rata, dan count sesuai format yang diminta
    printf("%lld\n", total_sum);
    printf("%.2f\n", average_val);
    printf("%d\n", above_average_count);
...
// Delimiter: End of Code (nilai_02.c)
